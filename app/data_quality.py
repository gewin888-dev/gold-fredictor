...
DELAYED_FREE_SOURCES = {"YAHOO", "YAHOO FINANCE", "SINA", "SINA FINANCE", "GDELT", "NEWSAPI", "GOOGLE_TRENDS"}
TEST_SOURCES = {"TEST"}
PLACEHOLDER_SOURCES = {"SAMPLE", "ESTIMATE", "MANUAL", "UNKNOWN"}
DERIVED_MODEL_PREFIXES = ("RULE_", "OPTIMIZED_", "AUTO_", "BACKFILL_")
